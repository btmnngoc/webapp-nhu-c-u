...
# Nhập mã sản phẩm, chọn mô hình và granularity
...
if ma_san_pham:
    ...
    if don_hang is None or sua_chua is None:
        ...
        feature_cols = [f'lag_{lag}' for lag in ([1, 2, 3, 4, 12] if granularity == 'M' else [1, 2, 3, 4, 52])] + \
        ...
        with tab4:
            ...
            freq = 'W' if granularity == 'W' else 'MS'
